  ...
  if (os === "darwin") {
    ...
    return {
      ...
      command: [
        ...
        'log stream --predicate \'process == "tart" OR process CONTAINS "Virtualization" OR process CONTAINS "CryptoTokenKit"\' > tart.log 2>&1 &',
        'TART_LOG_PID=$!',
        ...
        'echo "Starting VM..."',
        `tart run ${vmName} --no-graphics > vm.log 2>&1 &`,
        ...
        '    log show --predicate \'process == "tart" OR process CONTAINS "Virtualization" OR process CONTAINS "CryptoTokenKit"\' --last 5m || echo "No system logs found"',
        '    echo "Checking VM process:"',
        '    ps -p $VM_PID || echo "VM process not found"',
        '    echo "Checking VM network:"',
        '    netstat -an | grep LISTEN | grep -i tart || echo "No tart network connections found"',
        '    exit 1',
        '  fi',
