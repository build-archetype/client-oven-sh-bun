...
elseif(DEFINED CACHE_PATH)
  ...
  # Fallback to build directory if no cache path is defined
  setenv(CCACHE_DIR ${BUILD_PATH}/cache/ccache)
  file(MAKE_DIRECTORY ${BUILD_PATH}/cache/ccache)
  message(STATUS "🔧 Using fallback ccache directory: ${BUILD_PATH}/cache/ccache")
  message(STATUS "🔍 Debug: No CACHE_PATH defined, using BUILD_PATH=${BUILD_PATH}")
endif()
